...
internal sealed class GetPostsByUserIdQueryHandler(
    ...
    : IQueryHandler<GetPostsByUserIdQuery, (List<PostDto>, int, int)>
{
    public async Task<Result<(List<PostDto>, int, int)>> Handle(GetPostsByUserIdQuery query, CancellationToken cancellationToken)
    {
